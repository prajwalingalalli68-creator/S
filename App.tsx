...
const App: React.FC = () => {
  const [view, setView] = useState<'dashboard' | 'creator' | 'preview'>('dashboard');
              ...
              <div className="glass-panel border-white/10 rounded-[4rem] p-20 relative overflow-hidden">
                <div className="relative z-10 max-w-3xl">
                  ...
                  <h2 className="text-7xl font-black mb-10 leading-[0.95] tracking-tighter text-white heading-font">
                    Assessment <br/>
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-violet-400 to-rose-400 drop-shadow-2xl">Evolution.</span>
                  </h2>
                  <p className="text-slate-400 text-2xl mb-14 leading-relaxed font-medium">
                    The next-gen academic matrix. Generate complex papers with synchronized multi-part questions, multimodal references, and cinematic layouts.
                  </p>
                  <div className="flex flex-wrap gap-6">
                    ...
                    <div className="flex items-center gap-4 px-10 py-6 rounded-[2rem] border border-white/10 bg-white/5 backdrop-blur-md text-sm font-black uppercase tracking-widest text-slate-300">
                ...
                <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-rose-500/10 rounded-full -mr-20 -mb-20 blur-[120px] animate-pulse" style={{animationDelay: '1s'}}></div>
                <div className="absolute top-1/2 right-20 -translate-y-1/2 opacity-30 pointer-events-none scale-150 rotate-12">
                   <i className="fas fa-microchip text-[250px] text-white/10"></i>
                </div>
              </div>
            </section>
